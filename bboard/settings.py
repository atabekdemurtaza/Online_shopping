...
SECRET_KEY = 'fgmfra1@@xpcblqm&ffv9pbq!igup71)^!83p-l5ani1o0%71z'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'main.middlewares.bboard_context_processor', #Мы добавили обработчика пагинации
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(BASE_DIR, 'bboard.settings'),
    }
}
